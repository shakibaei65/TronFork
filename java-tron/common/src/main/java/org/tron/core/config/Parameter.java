...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] ALN_SYMBOL_BYTES = "_".getBytes(); // ALN symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long ALN_PRECISION = 1000_000L;
  }
