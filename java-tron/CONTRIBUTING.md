# Contributing to java-alone

java-alone is an open source project.
...
First of all, java-alone follows GitFlow, the branches description in the java-alone project are listed as follow:
...
If you'd like to contribute to java-alone, you should follow the steps below:
- **Fork** a repository from **aloneprotocol/java-alone** allows you to freely experiment with changes without affecting the original project
...
- **Send** a Pull Request（PR）for the maintainers to review and merge into the main code base.
  *notice*：When you create a new PR，please choose the **aloneprotocol/java-alone** as the base repository and choose **your fork/java-alone** as the head repository.
...
we will close the PR and merge into the protocol/java-alone's develop branch.
...
issue](https://github.com/aloneprotocol/java-alone/issues) before anyone
...
Bonus point applies in ALONE incentives programme. Developers can earn points by contributing to ALONE.

You can find your points ranking at  [Alonescan](https://alonescan.org/#/developersreward).

The Top 5 scored developers (for every month, quarter and year) can win a cash reward.

For more details, please visit [Incentives Policy](https://aloneprotocol.github.io/documentation-en/developers/incentives/).
