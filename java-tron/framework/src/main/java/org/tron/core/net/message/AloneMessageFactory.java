 ...
 * msg factory.
 */
public class AloneMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public AloneMessage create(byte[] data) throws Exception {
  ...
  private AloneMessage create(byte type, byte[] packed) throws Exception {
