...
public class AloneNetService {
  ...
  public void start() {
    ...
    logger.info("AloneNetService start successfully.");
  }
  ...
  public void stop() {
    ...
    logger.info("AloneNetService closed successfully.");
  }
  ...
  protected void onMessage(PeerConnection peer, AloneMessage msg) {
    try {
      switch (msg.getType()) {
  ...
  private void processException(PeerConnection peer, AloneMessage msg, Exception ex) {
    ReasonCode code;
