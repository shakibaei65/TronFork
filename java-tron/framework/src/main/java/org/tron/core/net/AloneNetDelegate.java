...
public class AloneNetDelegate {
  ...
  public boolean contain(Sha256Hash hash, MessageTypes type) {
    ...
    } else if (type.equals(MessageTypes.ALN)) {
  ...
  public void pushTransaction(TransactionCapsule aln) throws P2pException {
    try {
      ...
      throw new P2pException(TypeEnum.BAD_ALN, e);
      ...
      throw new P2pException(TypeEnum.ALN_EXE_FAILED, e);
    }
  }
