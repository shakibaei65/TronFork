...
public class AloneApplicationContext extends AnnotationConfigApplicationContext {

  public AloneApplicationContext() {
  }

  public AloneApplicationContext(DefaultListableBeanFactory beanFactory) {
    super(beanFactory);
  }

  public AloneApplicationContext(Class<?>... annotatedClasses) {
    super(annotatedClasses);
  }

  public AloneApplicationContext(String... basePackages) {
    super(basePackages);
  }
