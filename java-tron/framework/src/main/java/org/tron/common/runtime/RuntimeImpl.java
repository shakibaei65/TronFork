...
public class RuntimeImpl implements Runtime {
  ...
  public void execute(TransactionContext context)
    ...
    ContractType contractType = context.getAlnCap().getInstance().getRawData().getContract(0)
        .getType();
    switch (contractType.getNumber()) {
      ...
      case ContractType.CreateSmartContract_VALUE:
        ...
        break;
      default:
        actuatorList = ActuatorCreator.getINSTANCE().createActuator(context.getAlnCap());
    }
    if (actuator2 != null) {
