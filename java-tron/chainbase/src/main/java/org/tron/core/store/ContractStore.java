...
@Slf4j(topic = "DB")
@Component
public class ContractStore extends AloneStoreWithRevoking<ContractCapsule> {
   ...
   */
  public byte[] findContractByHash(byte[] alnHash) {
    return revokingDB.getUnchecked(alnHash);
  }
