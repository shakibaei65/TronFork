...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.AlnType alnType,
    ...
    if (alnType == ALN_CONTRACT_CREATION_TYPE) {
    ...
    } else if (alnType == ALN_CONTRACT_CALL_TYPE) {
